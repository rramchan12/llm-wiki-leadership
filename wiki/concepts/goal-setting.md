...
**Definition:** The deliberate practice of setting clear, challenging objectives to direct focus, filter reality, and boost motivation. Grounded in Locke & Latham's research showing properly set goals increase motivation by ~25%.

## Why It Matters

Goals and fears are the brain's primary filters on reality. Without clear goals, attention scatters. With them, the brain amplifies signals that support the objective and dampens distractions. Humans are visually oriented, goal-directed creatures — hardwired to go where they look.

## How Books Treat This

| Book | Stance | Key Insight |
|------|--------|-------------|
| [[kotler-gnar-country]] | Applied framework | Goals filter reality. Stare at the line you want to ski, not the rocks you want to avoid. If you ski a line while fearing it, your brain filters for the scary stuff and anxiety grows. Goals reverse this. |
| [[kotler-art-of-impossible]] | Extends | High, Hard Goals (HHGs) are 10x–25x larger than normal goals. Connected to a Massively Transformative Purpose (MTP), they prime the brain's pattern recognition to notice relevant opportunities. Break HHGs into clear daily goals. |
| [[watkins-first-90-days]] | Applies | [[early-wins]] in the first 30–60 days are goal-setting applied to transitions. Goals must align with STARS situation and boss expectations. |
...
- **Locke & Latham's research:** Specific, challenging goals boost motivation ~25% over vague or easy goals
- **Goals as filters:** Your brain highlights information that supports your goals and suppresses what doesn't
- **Visual orientation:** Humans go where they look. Stare at the target with "excited curiosity"
- **Fear vs. goals:** If fear is your filter, you see threats. If goals are your filter, you see opportunities.
- **Track progress:** Performance journals make invisible gains visible and sustain motivation

## Connections

- Related: [[flow-states]], [[ruthless-prioritization]], [[fear-management]], [[intrinsic-motivation]], [[values-based-action]], [[early-wins]], [[time-management-matrix]], [[procrastination-framework]]
- Applied in: [[incremental-progression]], [[peak-performance-aging]], [[pursuing-impossible-goals]], [[starting-a-new-leadership-role]], [[building-effective-habits-and-systems]], [[overcoming-procrastination]]
